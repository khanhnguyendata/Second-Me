...
class MultiTurnMessageBuilder(MessageBuilder):
    ...
    def build_messages(self, context: Optional[Any] = None) -> List[Dict[str, Any]]:
        ...
        # Filter out any system messages from the request to prevent injection
        # Only allow system messages generated by the server
        messages = [msg for msg in self.chat_request.messages if msg.get("role") != "system"]
